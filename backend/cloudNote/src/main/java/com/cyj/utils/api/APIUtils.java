...
import com.cyj.utils.url.ThreeDES;
...
public static void main(String[] args) {
    ...
    public static String readContent(){
        ...
        String url="http://localhost:8080/ipfs/QmbTz7p6cGtgwgiz85BJqYzP48ZQBGEPjfkZGiN4iS3kpo";
        return getData(url);
    }

    //生成短链接
    public static String getShortLink(String longLink){
        String secret= ThreeDES.getBase64SecretLink(longLink);
        String url="https://www.mxnzp.com/api/shortlink/create?url="+secret+"&app_id="+DevelopConstants.APP_ID+"&app_secret="+DevelopConstants.APP_SECRET;;
        return getData(url);
    }
    //生成验证码
