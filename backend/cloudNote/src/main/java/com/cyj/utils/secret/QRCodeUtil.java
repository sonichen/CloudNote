...
public class QRCodeUtil {
    ...
    public static String upLoad(String uuid, BufferedImage image, String fileApi) throws IOException {
        String iconUrl = null;
        if (image!=null) {
            InputStream inputStream = bufferedImageToInputStream(image);
            Map<String, String> params = new HashMap<>(16);
            params.put("token", "oh, it's ok");
            String fileName = "G:\\"+uuid + ".png";
           String result= IPFSUtils.upload(fileName);
