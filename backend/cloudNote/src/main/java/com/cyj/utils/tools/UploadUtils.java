...
public class UploadUtils {
    ...
    public static String upload(String filePath,File imgFile)   {
       try{
           byte [] file=getBytesByFile(imgFile.getAbsolutePath());
           System.out.println(imgFile.getAbsolutePath());
//           String  filePath="http://8.130.8.164:8080/img/cloudnote/user/";
           //            设置唯一的id
           long n = (long)(Math.random() % 29) + 1;
           long n1 = (long)(Math.random() % 29) + 1;
           String fileName= (new SnowflakeIdUtils(n,n1).nextId())+".jpg";
